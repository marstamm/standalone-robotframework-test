...
def make_exe():
    ...
    python_config.run_module = "robot.run"
    ...
    # to our binary.
    # exe.add_python_resources(exe.pip_install(["pillow"]))
    # exe.add_python_resources(exe.pip_install(["-r", "src/requirements.txt"]))
    # exe.add_python_binary_module_search_path("/usr/lib")
